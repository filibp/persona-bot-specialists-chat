    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="bg-white border-b border-gray-200 p-4">
        <div className="flex items-center space-x-4">
          ...
          <div className={`w-10 h-10 ${specialist.color} rounded-full p-0.5`}>
            <img 
          ...
          <div className="flex flex-wrap gap-1">
            <Badge variant="outline" className="text-xs">
              {behavioralSettings.location}
            </Badge>
            <Badge variant="outline" className="text-xs">
              {behavioralSettings.approach}
            </Badge>
            <Badge variant="outline" className="text-xs">
              {behavioralSettings.experience}
            </Badge>
            <Badge variant="outline" className="text-xs">
              {behavioralSettings.continent}
            </Badge>
          </div>
        </div>
      </div>
